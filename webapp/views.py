...
def entry_not_found(request, exception, template_name='default.html'):
...
def predictImage(request):
    ...
    pred_path = 'D:/WORK/Project/Final/media'

    initial="."+filePathName
    final='D:/WORK/Project/Final/media/111.jpg'
    try:
    ...
    class ConvNet(nn.Module):
        ...
        def forward(self, input):
            ...
            # Above output will be in matrix form, with shape (256,32,125*125)
